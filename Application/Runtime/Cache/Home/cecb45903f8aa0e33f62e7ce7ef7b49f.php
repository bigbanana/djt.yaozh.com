...
<!--banner-->
    ...
    <div class="w intr">
    	<div class="w1 int intss ">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$ls): ?><div class="me mes">
                <div class="me-imgs"><img src="<?php echo ($ls['pic_title']); ?>"></div>
                <div class="me-w me-ww">
                    <div class="me-x">
                        <h3><a href="<?php echo U('index/newsDetail',array('id'=>$ls['id']));?>" target="_blank"><?php echo ($ls['title']); ?></a><span class="me-w-span"><?php echo date('Y-m-d',$ls['create_time']);?></span></h3>
                        <P><?php echo ($ls['description']); ?></P>
                    </div>
                </div>
            </div><?php endforeach; endif; ?>
            <div class="quotes">
