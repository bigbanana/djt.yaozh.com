...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
	...
	<tbody>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr bgcolor="white">
			...
			<td align="left"><?php echo ($vo["width"]); ?> x <?php echo ($vo["height"]); ?></td>
			<td align="center"><a href="<?php echo U('Adv/place_edit');?>?id=<?php echo ($vo["id"]); ?>">编辑</a> | <a href="<?php echo U('Adv/place_delete');?>?id=<?php echo ($vo["id"]); ?>" onclick='return confirm("确定删除吗？")'>删除</a></td>
