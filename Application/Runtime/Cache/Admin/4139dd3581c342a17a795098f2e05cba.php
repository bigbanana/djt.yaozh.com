...
<form method="post"  name="form1" action="" onSubmit="return CheckSubmit();">
	<table border="0" cellspacing="0" cellpadding="0" class="vbm">
		<tr bgcolor="#f5fbff" >
			...
			<td colspan="3"><input name="name" id="title" type="text" class="text" value="" size="50"> <font color="red">*</font></td>
		</tr>
		<tr bgcolor="#f5fbff" >
			<td width="50px" align="right">URL</td>
			<td colspan="3"><input name="content" id="url" type="text" class="text" value="" size="50"> <font color="red">*</font></td>
		</tr>
		<tr bgcolor="#f5fbff" >
			<td width="50px" align="right">排序</td>
			<td colspan="3"><input name="sort" id="url" type="text" class="text" value="" size="50"> <font color="red">*</font></td>
		</tr>
	</table>
