...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="ccc2">
		<ul>
	   <input class="sunjoin large" type="button" onClick="location.href='/admin/FriendLink/add'" value="添加友链">
		</ul>
	</div>
	<div id="sunjoin">
    <table border="0" cellspacing="0" cellpadding="0" class="vbm">
      ...
      <tbody>
    	...
    	<tr bgcolor="white">
    	  ...
    	  <td align="left"><a href="/index/newDetail/id/<?=$vo['id']?>.html" target="_blank"><?=$vo['name']?></a></td>
