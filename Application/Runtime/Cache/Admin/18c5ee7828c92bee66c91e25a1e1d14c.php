...
<form action="" method="get">
    <table border="0" cellspacing="0" cellpadding="0" class="vbm">
        ...
        <tr bgcolor="#ffffff">
            <td style="background-color:#f1f5f8; width:50%;text-align:right">
                标识
            </td>
            <td>
                &nbsp;
                <input name="name" class="text" value="<?php echo $_GET['name'];?>">
            </td>
        </tr>
        <tr bgcolor="#ffffff">
            <td style="background-color:#f1f5f8; width:50%;text-align:right">
            ...
            <td>
                &nbsp;
                <input name="title" class="text" value="<?php echo $_GET['title'];?>">
            </td>
        </tr>
        <tr bgcolor="#ffffff">
            <td style="background-color:#f1f5f8; width:50%;text-align:right">
            ...
            <td>
                ...
                <select name="place_id">
                    ...
                    <?php if(is_array($place)): foreach($place as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php if($vo[id] == $_GET['place_id']): ?>selected<?php endif; ?>>
                        <?php echo ($vo['title']); ?>
...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
	...
	<tbody>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr bgcolor="white">
			...
			<td align="left"><?php echo ($vo["place_title"]); ?></td>
			<td align="left"><img src="<?php echo ($vo["content"]); ?>" style='max-height:100px;max-width:610px' /></td>
			<!-- <td align="left"><?php echo ($vo["begin_time"]); ?></td>
			<td align="left"><?php echo ($vo["end_time"]); ?></td> -->
			<td align="left"><?php echo ($vo["url"]); ?></td>
			<td align="center"><a href="<?php echo U('Adv/edit');?>?id=<?php echo ($vo["id"]); ?>">编辑</a> | <a href="<?php echo U('Adv/delete');?>?id=<?php echo ($vo["id"]); ?>" onclick='return confirm("确定删除吗？")'>删除</a></td>
