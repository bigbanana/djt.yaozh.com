var	fixedX = -1			// x position (-1 if to appear below control)
	...
	var imgDir = "/public/images/calendar/"			// directory for images ... e.g. var imgDir="/img/"
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(ctl, ctl2, format) {  
	    ...
	    if(ev.pageX || ev.pageY){  
	        ...
	        var	leftpos = ev.clientX + document.body.scrollLeft - document.body.clientLeft;  
	        var	toppos = ev.clientY + document.documentElement.scrollTop;
	    }
	    // console.log(ev);
		if (bPageLoaded)
		{
